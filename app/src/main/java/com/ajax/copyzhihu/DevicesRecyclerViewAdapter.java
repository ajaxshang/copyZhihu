 ...
 */
public class DevicesRecyclerViewAdapter extends RecyclerView.Adapter<DevicesRecyclerViewAdapter.BboxRecyclerViewHolder> {
    ...
    public class BboxRecyclerViewHolder extends RecyclerView.ViewHolder {
